...
define config.name = _("Affrayd of Love Ascended Dating")
...
define build.name = "AffraydofLoveAscendedDating"
...
define config.save_directory = "AffraydofLoveAscendedDating-1532918861"
